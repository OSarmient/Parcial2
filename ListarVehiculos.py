...
class Ui_ListarVehiculos(object):
    def setupUi(self, ListarVehiculos):
        ...
        self.retranslateUi(ListarVehiculos)
        self.NoPlaca.clicked.connect(self.get_Vehicles)
        QtCore.QMetaObject.connectSlotsByName(ListarVehiculos)

    def retranslateUi(self, ListarVehiculos):
        _translate = QtCore.QCoreApplication.translate
        ListarVehiculos.setWindowTitle(_translate("ListarVehiculos", "MainWindow"))
        ...
        item.setText(_translate("ListarVehiculos", "Uid"))
        item = self.tableWidget.horizontalHeaderItem(11)
        item.setText(_translate("ListarVehiculos", "Random"))

    def get_Vehicles(self, ListarVehiculos):
        vehicles=Vehicles()
        data =vehicles.get_all()
        row = 0
        for i in data:
            col = 0
            keys = i.keys()
