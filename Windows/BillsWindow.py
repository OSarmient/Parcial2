...
class BillsWindow:
    def __init__(self, ui):
        ...
        ui.BotonCrearF.clicked.connect(self.show_create)
        ui.BotonBorrarF.clicked.connect(self.show_delete)
        ui.BotonListarF.clicked.connect(self.show_list)
