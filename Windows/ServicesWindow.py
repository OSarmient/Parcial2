...
class ServicesWindow:
    ...
    def delete(self):
        delete = self.module.delete(self.uis["delete"].UniqueProp.toPlainText(), "numero")
        if delete == False: print("No existe un servicio con ese codigo")
        else: print("Servicio eliminado")  
